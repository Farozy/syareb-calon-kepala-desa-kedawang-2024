...
export default function Navbar() {
    ...
    const handleScroll = () => {
        if (window.scrollY > 0) {
            ...
            setScrollBackground("shadow-none bg-transparent");
    ...
    useEffect(() => {
        ...
        navbarOpen ? document.body.style.overflowY = 'hidden' : document.body.style.overflowY = 'auto';
    }, [navbarOpen]);
        ...
        <>
            ...
            >
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                    {navbar.map((item: any, index: number, array: any) => (
                ...
                <div
                    className={`hidden cursor-text lg:inline-block py-2 px-6 bg-transparent border-[3px] border-blue-600 rounded-xl text-sm ${scrollColor} font-bold text-white`}>
                    Pilih No. 4
                </div>
            </nav>
